 ...
 * @Last Modified time: 2019-03-29 12:15:28
 */
<template>
  <div class="home">
      ...
      <el-header class="homeHeader">
        ...
        <div class="homeNav">
          <ul class="homeNavMenu">
            ...
            <li :class="{active: activePath== item.path}" v-for="(item,index)  in navList " :key="index" class="file" @click="goNav(item)">{{item.name}} </li> 
            ...
            <div class="userWrap" style="margin-left:;color: #588bc6;">
              ...
              <p class="userName" >{{userName}}已登录</p>
